package com.ecom.api.discountservice.security;



import com.ecom.api.discountservice.config.JwtProperties;
import com.ecom.api.discountservice.model.TokenClass;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            TokenClass tokenData = mapper.readValue(tokenJson, TokenClass.class);
